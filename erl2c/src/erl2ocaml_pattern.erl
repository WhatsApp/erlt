...
dedup_pattern1({var,Line,V}, Env) ->
    V1 =
        case proplists:is_defined(V, Env) of
            true ->
                list_to_atom("_p'" ++ atom_to_list(V) ++ integer_to_list(erlang:length(Env)));
            false ->
                V
        end,
    Env1 = [{V, V1} | Env],
...
dedup_pattern1({enum,L1,{op,L2,'.',{op,L3,'.',{atom,L4,Mod},{atom,L5,Enum}},{atom,L6,Ctr}},Args}, Env) ->
    {Args1, Env1} = dedup_patterns1(Args, Env),
    {{enum,L1,{op,L2,'.',{op,L3,'.',{atom,L4,Mod},{atom,L5,Enum}},{atom,L6,Ctr}},Args1}, Env1};
...
destruct_pattern1({atom,Line,A}, Env) ->
    {{atom,Line,A}, Env};
destruct_pattern1({enum,L1,{op,L2,'.',{atom,L3,Enum},{atom,L4,Ctr}},Args}, Env) ->
    {Args1, Env1} = destruct_patterns1(Args, Env),
    {{enum,L1,{op,L2,'.',{atom,L3,Enum},{atom,L4,Ctr}},Args1}, Env1};
destruct_pattern1({enum,L1,{op,L2,'.',{op,L3,'.',{atom,L4,Mod},{atom,L5,Enum}},{atom,L6,Ctr}},Args}, Env) ->
    {Args1, Env1} = destruct_patterns1(Args, Env),
    {{enum,L1,{op,L2,'.',{op,L3,'.',{atom,L4,Mod},{atom,L5,Enum}},{atom,L6,Ctr}},Args1}, Env1};
