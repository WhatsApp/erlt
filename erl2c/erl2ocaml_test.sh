...
~/.opam/default/bin/ocamlformat --enable-outside-detected-project mod04.raw._.mli -o mod04._.mli;
diff mod04._.mli mod04.mli;
~/.opam/default/bin/ocamlformat --enable-outside-detected-project mod04.raw._.ml -o mod04._.ml;
