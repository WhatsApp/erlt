...
class ParseTypesSpec extends org.scalatest.FunSpec {
  ...
  describe("Types") {
    ...
    testType(
      ...
      FunType(
        ...
        UserType(LocalName("option"),List(TypeVar("B")(NP)))(NP))(NP),
    )
    ...
    testType(
      "fun(([A]) -> [A])",
      FunType(
        List(ListType(TypeVar("A")(NP))(NP)),
        ListType(TypeVar("A")(NP))(NP))(NP),
    )
    ...
    testSpecType(
      ...
      Spec(
        ...
        FunType(
          List(ListType(TypeVar("A")(NP))(NP)),
          ListType(TypeVar("A")(NP))(NP))(NP))(NP)
    )
  }
  ...
  describe("Type definitions") {
    testTypeDefs(
      "-enum void() :: .",
      List(EnumDef("void", List(), List())(NP)))

    testTypeDefs(
      "-enum void(A) :: .",
      List(EnumDef("void", List(TypeVar("A")(NP)), List())(NP)))
    ...
    testTypeDefs(
      "-enum box() :: box{}.",
      List(EnumDef("box", List(), List(EnumCon("box", List())(NP)))(NP)))

    testTypeDefs(
      "-enum box2(A) :: box2{A, A}.",
      List(EnumDef("box2",
        List(TypeVar("A")(NP)), List(EnumCon("box2", List(TypeVar("A")(NP), TypeVar("A")(NP)))(NP)))(NP)))

    testTypeDefs(
      "-enum box2(A, B) :: box2{A, B}.",
      List(EnumDef("box2",
        List(TypeVar("A")(NP), TypeVar("B")(NP)),
        List(EnumCon("box2", List(TypeVar("A")(NP), TypeVar("B")(NP)))(NP)))(NP)))

    testTypeDefs(
      "-enum box2(A, B) :: box2{A, B} | box1{A}.",
      List(
        EnumDef("box2", List(TypeVar("A")(NP), TypeVar("B")(NP)),
          List(
    ...
    testTypeDefs(
      ...
      List(
        EnumDef("box1",
          List(TypeVar("A")(NP)),
          List(EnumCon("box1", List(TypeVar("A")(NP)))(NP)))(NP),
        EnumDef("box2",
          List(TypeVar("A")(NP)),
          List(EnumCon("box2", List(UserType(LocalName("box1"), List(TypeVar("A")(NP)))(NP)))(NP)))(NP)))
  }
