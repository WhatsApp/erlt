...
class UnknownStruct(pos: Pos.P, name: String) extends PositionedError(pos, s"Unknown struct: #$name{}", None)
class UnknownStructField(pos: Pos.P, structName: String, fieldName: String)
    extends PositionedError(pos, s"Unknown field #$structName.$fieldName", None)
class UnInitializedStructField(pos: Pos.P, structName: String, fieldName: String)
    extends PositionedError(pos, s"Uninitialized field #$structName.$fieldName", None)
class UnconditionalExceptionUpdate(pos: Pos.P, recordName: String)
    extends PositionedError(pos, s"Unconditional update. $recordName is exception()", None)
class UnconditionalMessageUpdate(pos: Pos.P, recordName: String)
    extends PositionedError(pos, s"Unconditional update. $recordName is message()", None)
class UnconditionalExceptionSelect(pos: Pos.P, recordName: String)
    extends PositionedError(pos, s"Unconditional select. $recordName is exception()", None)
class UnconditionalMessageSelect(pos: Pos.P, recordName: String)
    extends PositionedError(pos, s"Unconditional select. $recordName is message()", None)
class IllegalCatchPattern(pos: Pos.P) extends PositionedError(pos, s"Illegal catch pattern", None)
class IllegalReceivePattern(pos: Pos.P) extends PositionedError(pos, s"Illegal receive pattern", None)
...
class MessageType(pos: Pos.P, messageName: String)
    extends PositionedError(pos, s"#$messageName{} is not a type. Did you mean `message()`?", None)
