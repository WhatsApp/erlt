...
maximum([]) ->
    {969696, maybe, maybe, nothing};
maximum([H | T]) ->
    {969696, maybe, maybe, just, foldl(fun basics:max/2, H, T)}.
...
minimum([]) ->
    {969696, maybe, maybe, nothing};
minimum([H | T]) ->
    {969696, maybe, maybe, just, foldl(fun basics:min/2, H, T)}.
