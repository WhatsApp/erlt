...
-type triple(A, B, C) :: {969696, mod03, triple, triple, A, B, C}.


-type my_list(A) ::
          {969696, mod03, my_list, cons, A, my_list(A)} |
          {969696, mod03, my_list, nil}.


-type option(A) ::
          {969696, mod03, option, none} |
...
zero({969696, mod03, unit0, unit0}, Val) ->
    Val.
...
un_either(Either) ->
    case Either of
        {969696, mod03, either, left, Elem} ->
            Elem;
        {969696, mod03, either, right, Elem} ->
            Elem
    end.
...
first({969696, mod03, pair, pair, F, _}) ->
    F.
...
second({969696, mod03, pair, pair, _, S}) ->
    S.
