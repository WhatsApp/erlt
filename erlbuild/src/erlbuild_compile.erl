        ...
        case CompileMode of
            makedep2 ->
                ...
                TransformPasses = [
                    ...
                    || member(makedep2_run_parse_transforms, Options0)
                ],
                [
                    ?pass(parse_module),
...
compile_forms(Forms, St0) ->
    ...
    Ret =
        compile:noenv_forms(Forms, [{source, St0#compile.filename} | St0#compile.options]),
